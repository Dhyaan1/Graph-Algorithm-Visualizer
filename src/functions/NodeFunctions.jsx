...
function createAdjacencyGraph(
  ...
  function DeleteNode(NodeId, myNodes, myEdges, setMyEdges, setMyNode, setDisableDeleteNode, setSelections) {
...
export { CreateDFS, CreateBFS, create2DArray, createAdjacencyGraph, DeleteNode, bfsCall};
